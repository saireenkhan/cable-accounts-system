...
export default function PackagesPage() {
  ...
  const [editingPackage, setEditingPackage] = useState<any>(null); // ✅ edit mode
  ...
  const fetchPackages = async () => {
    try {
      ...
      if (response.data.success) {
        const formattedPackages = response.data.packages.map(
    ...
    <Layout>
      <div className="space-y-5">
                    ...
                    <div className="flex items-center gap-3">
                      <div
                        className={cn(
                          'p-3 rounded-xl',
                          bgColorClasses[
                            pkg.color as keyof typeof bgColorClasses
                          ]
                        )}
                      >
                        <span
                          className={
                            iconColorClasses[
                              pkg.color as keyof typeof iconColorClasses
                            ]
                          }
                        >
                  ...
                  <div className="mb-4">
                    <p
                      className={cn(
                        'text-3xl font-bold',
                        priceColorClasses[
                          pkg.color as keyof typeof priceColorClasses
                        ]
                      )}
                    >
        ...
        <AddUserModal
          ...
          submitLabel={editingPackage ? 'Update Package' : 'Add Package'}
          color="blue"
          endpoint={
            editingPackage ? `/packages/${editingPackage.id}` : '/packages'
          }
